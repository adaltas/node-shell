...
Parameters.prototype.route = function(argv = process, ...args) {
  var commands, config, configure, err, i, index, params, route, route_call, route_error, route_from_config;
  // Normalize arguments
  ...
  // Load a command route
    ...
    return route_from_config(config, commands, params);
  } else {
    // Load an application route
    return route_from_config(this.config, [], params);
  }
};
