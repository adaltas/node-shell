...
Parameters.prototype.decode = function(argv) {
  var command, key, main, option, options, params, shortcut, value, _i, _len, _name, _name1, _ref, _ref1, _ref2, _ref3;
  if (argv == null) {
    argv = process.argv;
  }
  ...
  while (true) {
    ...
    if (shortcut) {
      key = this.shortcuts[params.action][key];
    }
  ...
  options = this.config.actions[params.action].options;
  if (options) {
    for (_i = 0, _len = options.length; _i < _len; _i++) {
      ...
      if ((_ref2 = params[_name = option.name]) == null) {
        params[_name] = null;
      }
    }
  }
  main = this.config.actions[params.action].main;
  if (main) {
    if (main.required) {
    ...
    if ((_ref3 = params[_name1 = main.name]) == null) {
      params[_name1] = null;
    }
  }
  return params;
