 ...
 */
var Parameters, is_object, load, pad, types,
  indexOf = [].indexOf;
...
Parameters = function(config = {}) {
  var command, commands, i, k, len, makeCommand, options, ref, v;
  this.config = config;
  // Sanitize options
  ...
  if (is_object(config.commands)) {
    // Convert from object with keys as command name to an array
...
Parameters.prototype.stringify = function(params, options = {}) {
  ...
  // Stringify
  stringify = (config) => {
    var key, l, len2, len3, m, ref2, val, value;
    ref2 = config.options;
...
Parameters.prototype.help = function(command) {
  var config, content, describeCommand, describeOption, i, j, l, len, len1, len2, main, option, options, ref, ref1, ref2, synopsis;
