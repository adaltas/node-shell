// Generated by CoffeeScript 2.0.2
  ...
  * type:     one of 'string', 'boolean', 'integer' or 'array'
   ...
   */
var Parameters, array_to_object, is_object, load, merge, pad, params_to_commands, set_default, types,
  indexOf = [].indexOf;
...
Parameters.prototype.helping = function(params) {
  var commands;
  return commands = params_to_commands(this.config, params);
};
...
Parameters.prototype.help = function() {
  ...
  if (is_object(args[0])) {
    ...
    if (!(commands = params_to_commands(this.config, args[0]))) {
      return;
    }
  } else {
...
params_to_commands = require('./params_to_commands');
