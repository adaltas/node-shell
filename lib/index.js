    ...
    return function(config) {
      ...
      if (argv.length !== index) {
        ...
        if (config.main) {
          ...
          if ((_ref1 = config.commands) != null ? _ref1[argv[index]] : void 0) {
...
Parameters.prototype.help = function(command) {
  var config, content, describeCommand, describeOption, main, option, options, synopsis, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
