...
Parameters.prototype.help = function() {
  var _, arg, args, cmd, command, commands, config, configs, content, description, has_help_command, has_help_option, i, j, l, len, len1, len2, len3, len4, line, m, n, name, o, option, options, ref, ref1, ref2, ref3, shortcut, synopsis;
  args = Array.prototype.slice.call(arguments);
  // Get options
  if (args.length > 1) {
