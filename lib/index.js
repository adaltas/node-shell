...
Parameters = function(config) {
  var action, command, main, option, _base, _base1, _base2, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
  ...
  if ((_ref3 = (_base = this.config.actions).help) == null) {
    _base.help = {};
  }
  if ((_ref4 = (_base1 = this.config.actions.help).description) == null) {
    _base1.description = "Display help information about " + this.config.name;
  }
  if ((_ref5 = (_base2 = this.config.actions.help).main) == null) {
    _base2.main = {
      name: 'command',
