...
Parameters.prototype.configure = function(config) {
  var properties, sanitize_command, sanitize_commands, sanitize_commands_enrich, sanitize_help, sanitize_main, sanitize_options, sanitize_options_enrich, sanitize_route;
  this.config = config;
  properties = {};
  // Sanitize options
