...
Parameters.prototype.parse = function(argv = process, options = {}) {
  var appconfig, command_params, full_params, index, j, k, len, params, parse, v;
...
Parameters.prototype.help = function(commands = [], options = {}) {
  var _, appconfig, cmd, command, config, configs, content, description, has_help_command, has_help_option, i, j, l, len, len1, len2, len3, line, m, n, name, option, ref, ref1, ref2, ref3, ref4, shortcut, synopsis;
