...
describe("configure", function () {
  describe("normalisation", function () {
    ...
    it("empty without command does not throw errors", function () {
      shell({}).config().get();
    });

    it('set default command name as "command" if commands available', function () {
      shell({
        commands: {
          my_cmd: {},
        },
        ...
        .config()
        .get()
        .command.should.eql("command");
    });

    it("nested empty commands", function () {
      shell({
        commands: {
          parent_cmd: {
            commands: {
