...
describe("commands", function () {
  it("no property is required", function () {
    const app = shell({
      commands: { start: {} },
    });
  ...
  it("commands validate to an object", function () {
    (function () {
      shell({
        commands: [],
      });
  ...
  it("options is of type object", function () {
    const app = shell({
      commands: {
        start: {
          options: {
  ...
  it("customize command name", function () {
    const app = shell({
      command: "mycommand",
      commands: { start: {} },
    });
  ...
  it("mix with general options", function () {
    const app = shell({
      options: { gopt: {} },
      commands: {
        start: {
  ...
  describe("nested", function () {
    it("with the same command name", function () {
      const app = shell({
        options: { opt_root: {} },
        commands: {
          parent: {
