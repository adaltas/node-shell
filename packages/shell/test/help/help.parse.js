...
describe("help/help.parse", function () {
  describe("dont interfere with command", function () {
    ...
    it("handle an empty command as help", function () {
      shell({
        commands: {
          help: {},
        },
    ...
    it("handle an empty command as even if help is not defined", function () {
      shell({
        commands: {
          fake: {},
        },
    ...
    it("global options without a command", function () {
      shell({
        commands: {
          fake: {},
        },
  ...
  it("handle help command", function () {
    const app = shell({
      commands: {
        help: {},
      },
  ...
  it("handle help command with a command", function () {
    const app = shell({
      commands: {
        toto: {},
      },
