...
describe("options.type", function () {
  ...
  describe("boolean", function () {
    it("handle boolean option", function () {
      const app = shell({
        commands: {
          start: {
            options: {
    ...
    it("bypass a boolean option set to null", function () {
      const app = shell({
        options: {
          detached: {
            shortcut: "d",
  ...
  describe("integer", function () {
    ...
    it("validate", function () {
      ...
      (function () {
        ...
        'Invalid Option: value of "an_int" is not an integer, got "invalid"',
      );
    });
  });
  ...
  describe("array", function () {
    ...
    it("handle multiple properties", function () {
      const app = shell({
        commands: {
          start: {
            options: {
    ...
    it("handle empty values", function () {
      const app = shell({
        commands: {
          start: {
            options: {
      ...
      app
        .parse(["start", "--my_array", "", "--my_array", "2", "--my_array", ""])
        .should.eql({
          command: ["start"],
          my_array: ["", "2", ""],
        });
